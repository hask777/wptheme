<?php get_header('uza'); ?>
                        ...
                        <div class="row h-100 align-items-center">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="welcome-thumbnail">
                                    <img src="<?php echo get_template_directory_uri() . '/assets/img/bg-img/1.png;' ?>" alt="" data-animation="slideInRight" data-delay="400ms">
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <section class="uza-about-us-area">
        ...
        <div class="about-bg-pattern">
            <img src="<?php echo get_template_directory_uri() . '/assets/img/core-img/curve-2.png';?>" alt="">
        </div>
    </section>
    <!-- ***** About Us Area End ***** -->
    ...
    <section class="uza-portfolio-area section-padding-80">
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="portfolio-sildes owl-carousel">
                    ...
                    <!-- Single Portfolio Slide -->
                    <div class="single-portfolio-slide">
                        <img src="<?php echo get_template_directory_uri() .'/assets/img/bg-img/6.jpg';?>" alt="">
                        <!-- Overlay Effect -->
                        <div class="overlay-effect">
                            <h4>Digital Marketing</h4>
                            <p>At vero eos et accusam et justo duo dolores et ea rebum. Stet gubergren no sea takimata sanctus est</p>
                        ...
                        <div class="testimonial-slides owl-carousel">
                            ...
                            <div class="single-testimonial-slide d-flex align-items-center">
                                ...
                                <div class="testimonial-content">
                                    ...
                                    <!-- Quote Icon -->
                                    <div class="quote-icon"><img src="<?php echo get_template_directory_uri() .'/assets/img/core-img/quote.png';?>" alt=""></div>
                                </div>
                            </div>
        ...
        <div class="portfolio-bg-curve">
            <img src="<?php echo get_template_directory_uri() .'/assets/img/core-img/curve-3.png';?>" alt="">
        </div>
    </section>
    <!-- ***** Portfolio Area End ***** -->
